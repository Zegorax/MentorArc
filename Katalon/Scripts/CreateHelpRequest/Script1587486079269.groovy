...
WebUI.waitForElementClickable(findTestObject('Page_MentorArc/a_Poulain pages'), 0)
...
WebUI.setText(findTestObject('Page_Form HelpRequest/input_Ok_timeBegin'), '15:00')
